...
LABEL ca.unb.lib.generator="simplesamlphp" \
  ...
  org.label-schema.vcs-url="https://github.com/unb-libraries/docker-simplesamlphp" \
  org.label-schema.vendor="University of New Brunswick Libraries" \
  org.label-schema.version=$VERSION \
  org.opencontainers.image.source="https://github.com/unb-libraries/docker-simplesamlphp"